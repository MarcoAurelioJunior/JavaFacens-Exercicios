...
public class functionNotes {
    ...
    public static void main(String[] args) { //Void = Função que não retorna algo
        ...
        Scanner scanner = new Scanner(System.in);
            ...
            System.out.println(calculoMedia(valorNum1, valorNum2, valorNum3));
        scanner.close();
    }
    ...
    public static String calculoMedia(int num1, int num2, int num3) {
        return "O resultado da média vai ser de: " + (num1 + num2 + num3)/3; 
    }
}
